...
*/
extern unsigned int asciiToHex(const char *str, unsigned char *result, unsigned int maxHexLen) {
	unsigned int i = 0;
...
*/
extern unsigned int hexToAscii(const unsigned char *hex, unsigned int hexLen, char *str, unsigned int maxStrLen) {
